    ...
    <div className="min-h-screen bg-black">
      ...
      <section id="condo-grants" className="py-20 bg-black border-b border-neutral-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-invert max-w-4xl mx-auto">
            <p className="text-lg text-neutral-300 leading-relaxed mb-4">
              All Phase Construction USA assists condo associations in navigating available grants and funding programs for roofing replacements and repairs. Our team has extensive experience working with HOAs and property managers to secure financing options.
            </p>
            <p className="text-lg text-neutral-300 leading-relaxed">
          ...
          <div className="mt-8 rounded-2xl border border-red-500/40 bg-red-900/10 p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <p className="text-neutral-200 text-sm sm:text-base">
              Let All Phase Construction USA help your association explore funding options. Contact us for a consultation.
            </p>
            <a
              href="#contact"
              className="inline-flex items-center justify-center rounded-full bg-red-600 px-6 py-2.5 text-sm font-semibold text-white hover:bg-red-500 transition-colors duration-200 whitespace-nowrap"
