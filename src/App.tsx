      ...
      <section id="roof-types" className="py-20 bg-neutral-950 border-b border-neutral-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div id="flat" className="mb-12 scroll-mt-20">
            ...
            <p className="text-lg text-slate-300 leading-relaxed mb-4">
              Flat roofs are ideal for commercial buildings and modern residential designs. We install TPO, EPDM, and modified bitumen systems that provide excellent waterproofing and energy efficiency.
            </p>
          </div>
